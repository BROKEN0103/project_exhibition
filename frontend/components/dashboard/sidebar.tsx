...
export function Sidebar() {
    ...
    const navItems = [
        ...
        { href: "/feed", icon: Rss, label: "AI Feed" },
        { href: "/library", icon: BookOpen, label: "Vault Library" },
        { href: "/upload", icon: Upload, label: "Secure Ingest" },
        { href: "/clips", icon: Film, label: "AI Clips" },
        { href: "/distribution", icon: Share2, label: "Distribution" },
        ...
        <div className="hidden w-72 border-r border-white/5 bg-black/40 backdrop-blur-2xl md:flex flex-col sticky top-0 h-screen shrink-0 relative overflow-hidden">
            ...
            <div className="flex-1 overflow-y-auto px-6 py-4 relative z-10">
                <div className="space-y-6 mb-10">
                    <div>
                        <p className="px-4 mb-4 text-[10px] font-black uppercase tracking-[0.3em] text-slate-500">Platform</p>
                ...
                <div className="px-4 py-6 rounded-2xl bg-gradient-to-br from-blue-600/5 to-transparent border border-white/5">
                    <div className="flex items-center gap-2 mb-3">
                        ...
                        <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">AI Engine</span>
                    </div>
                    ...
                    <p className="text-[10px] text-slate-500 font-mono">AI_PROCESSING: ACTIVE</p>
                </div>
            </div>
